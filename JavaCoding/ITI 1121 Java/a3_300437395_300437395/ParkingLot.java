...
public class ParkingLot {
	...
	public void park(Car c, int timestamp) {
		...
		Spot temp = new Spot(c,timestamp);
		
		if(this.occupancy.isEmpty()){
			this.occupancy.addFirst(temp);
			
		}else if(this.occupancy.size() < capacity){
			this.occupancy.add(temp);
	...
	public boolean attemptParking(Car c, int timestamp) {
		...
		if(this.occupancy.size() < capacity){
	...
	public boolean isOccupancyEmpty(){
